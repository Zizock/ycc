function result = var_benchmark(data, prior, gssettings, printout)

% This script is to run Gibbs sampler to estimate my BVAR model.
% it is modified based on Jarocinski and Karadi (2020)

%=======================================================================
%% Notes from JK2020
%=======================================================================
% result = var_benchmark(data, prior, gssettings, printout)
